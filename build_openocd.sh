...
[[ -z ${OPENOCD_TOP_DIR+x} ]] && OPENOCD_TOP_DIR=$SCRIPT_DIR
[[ -z ${OPENOCD_VERSION+x} ]] && OPENOCD_VERSION="master"
[[ -z ${OPENOCD_INSTALL_PREFIX+x} ]] && OPENOCD_INSTALL_PREFIX="/usr/local"
[[ -z ${OPENOCD_CONFIGURE_OPTS+x} ]] && OPENOCD_CONFIGURE_OPTS="--enable-cmsis-dap"
[[ -z ${OPENOCD_J_LEVEL+x} ]] && OPENOCD_J_LEVEL=`nproc`
[[ -z ${OPENOCD_GIT_URL+x} ]] && OPENOCD_GIT_URL="git://git.code.sf.net/p/openocd/code"
[[ -z ${OPENOCD_WORKING_DIR+x} ]] && OPENOCD_WORKING_DIR="openocd"
